...
def train():
    ...
    for language_ix, (language_path, language_name) in enumerate(zip(language_paths, language_names)):
        ...
        if language_name in NON_TRANSFORMER_LANGUAGES:
...
if __name__ == '__main__':
    train()
    # evaluate('Finnish-TDT', '../data/2019/task2/UD_Finnish-TDT', 'LemmaTransformer', run_prediction=True)
    # evaluate('Ancient_Greek-PROIEL', '../data/2019/task2/UD_Ancient_Greek-PROIEL', 'LemmaTransformer')
    # evaluate_all(model_name=model_name)
